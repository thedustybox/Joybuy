...
import com.thedustybox.joybuy.common.utils.HttpUtils;
import com.thedustybox.joybuy.common.utils.PageUtils;
import com.thedustybox.joybuy.common.utils.Query;
import com.thedustybox.joybuy.member.dao.MemberDao;
...
public class MemberServiceImpl extends ServiceImpl<MemberDao, MemberEntity> implements MemberService {
    ...
    public MemberEntity login(MemberUserLoginVo vo) {
        ...
        //1、去数据库查询 SELECT * FROM ums_member WHERE username = ? OR mobile = ? 用户名登录与手机号登录
